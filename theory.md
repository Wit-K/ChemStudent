...
An experiment in this field takes place inside an **electrolytic cell**. Unlike a battery (which creates electricity from chemicals), an electrolytic cell uses an external power source to force non-spontaneous chemical reactions to happen.
...
*   **For our purpose:** This is the most important part of the setup. The material of the cathode (e.g., Copper, Gold, Tin) determines what product you make.
...
*   **What happens here:** To balance the electrons used at the cathode, something must lose electrons (oxidize) at the anode. In most aqueous experiments, water is oxidized into oxygen gas.
*   **Why it matters:** While we focus on the cathode, the anode is necessary to complete the circuit.
*   **Key Equation:** $$ 2H_2O \rightarrow O_2 + 4H^+ + 4e^- $$

### The Electrolyte
This is the liquid solution between the two electrodes. Pure water does not conduct electricity well, so we dissolve salts (like Potassium Bicarbonate, $KHCO_3$) into it.
*   **Function:** It allows ions (charged particles) to move between the cathode and anode to balance the charge. Without an electrolyte, the circuit is broken, and no reaction occurs.
